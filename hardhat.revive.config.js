...
for (const f of fs.readdirSync(path.join(__dirname, 'openzeppelin-contracts/hardhat'))) {
  require(path.join(__dirname, 'openzeppelin-contracts/hardhat', f));
}
...
module.exports = {
  ...
  warnings: {
    'openzeppelin-contracts/contracts-exposed/**/*': {
      'code-size': 'off',
      'initcode-size': 'off',
    },
    '*': {
  ...
  docgen: require('./openzeppelin-contracts/docs/config'),
};
